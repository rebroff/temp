<form class="feedback-frm feedback-frm--whatsapp">
   ...
   <input type="hidden" name="feedback-type" value="WhatsApp">
   <input type="hidden" name="whatsapp-link">
   
  <button class="feedback-frm__btn btn js-feedback-btn" type="submit">
    <div class="feedback-card feedback-card feedback-card--whatsapp">
      <div class="feedback-card__icon-wrapper">
         <svg class="svg-icon" width="67" height="68">
            <use xlink:href="assets/template/images/sprite.svg#whatsapp"></use>
         </svg>
      ...
      <div class="feedback-card__title">WhatsApp
      </div>
    </div>
